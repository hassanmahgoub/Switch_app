...
class ReportsSub4 extends StatefulWidget {
  const ReportsSub4({Key? key}) : super(key: key);

  @override
  State<ReportsSub4> createState() => _ReportsSub4State();
}

class _ReportsSub4State extends State<ReportsSub4> {
  @override
                  ...
                  Padding(
                    ...
                    progressColor: const Color(0xFf1D0D63),
                      ...
                      Column(children: [
                        ...
                        const Text('فحص الطريق',style: TextStyle(color: Color(0xffBE1E2D),fontFamily: 'sst bold',fontSize: 10)
                      )],)
                    ],),
                  ),
